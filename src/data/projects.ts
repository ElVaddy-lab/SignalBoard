...
export function createSampleProjects(anchor = new Date()): Project[] {
  ...
  > = [
    ...
    { id: "q2-marketing", title: "Q2 Marketing Campaign", description: "Deliver the campaign landing pages, messaging, and performance reporting for Q2.", status: "Review", priority: "Medium", projectLead: "Emma Davis", deadline: daysFrom(anchor, 4), completion: 40, completedAt: null, completedAfterDeadline: false, createdDaysAgo: 47, updatedDaysAgo: 2 },
